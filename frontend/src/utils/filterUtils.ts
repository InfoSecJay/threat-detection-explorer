...
// query_complexity) -- if they arrive from a bookmarked URL the
// backend still honors them, they just don't count as user-visible
// facets since there's no UI to toggle them.
