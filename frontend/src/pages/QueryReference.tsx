...
const OPERATORS: Array<{ token: string; desc: string; example: string }> = [
  ...
  { token: 'bare word', desc: 'No prefix = whole-word match across title, rule id, description, use cases, tags and extracted process names. Never the rest of the rule body: use content: for that.', example: 'powershell' },
];
