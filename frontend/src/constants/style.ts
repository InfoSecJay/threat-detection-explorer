...
// Hues MUST agree with `sourceColors` / `sourceTailwind` in
// constants/sources.ts (used by Home, the rule list and Integrations).
// They diverged for a while -- Sigma was purple on Home and blue on the
// Intel/MITRE/Actors pages, and Elastic swapped between blue and amber
// -- which made the same dot mean different sources on different
// pages. Source colour is identity here, not decoration.
export const sourceTheme: Record<string, SourceTheme> = {
  sigma:               { name: 'SigmaHQ',       dot: 'bg-purple-500', text: 'text-purple-400', border: 'border-purple-500/30', bg: 'bg-purple-500/20' },
  elastic:             { name: 'Elastic',       dot: 'bg-blue-500',   text: 'text-blue-400',   border: 'border-blue-500/30',   bg: 'bg-blue-500/20' },
  splunk:              { name: 'Splunk',        dot: 'bg-orange-500', text: 'text-orange-400', border: 'border-orange-500/30', bg: 'bg-orange-500/20' },
  sublime:             { name: 'Sublime',       dot: 'bg-pink-500',   text: 'text-pink-400',   border: 'border-pink-500/30',   bg: 'bg-pink-500/20' },
  elastic_protections: { name: 'Elastic Prot.', dot: 'bg-cyan-500',   text: 'text-cyan-400',   border: 'border-cyan-500/30',   bg: 'bg-cyan-500/20' },
  lolrmm:              { name: 'LOLRMM',        dot: 'bg-green-500',  text: 'text-green-400',  border: 'border-green-500/30',  bg: 'bg-green-500/20' },
  elastic_hunting:     { name: 'Elastic Hunt',  dot: 'bg-violet-500', text: 'text-violet-400', border: 'border-violet-500/30', bg: 'bg-violet-500/20' },
  sentinel:            { name: 'Sentinel',      dot: 'bg-blue-400',   text: 'text-blue-300',   border: 'border-blue-400/30',   bg: 'bg-blue-400/20' },
  ...
  auth0:               { name: 'Auth0',         dot: 'bg-amber-500',  text: 'text-amber-400',  border: 'border-amber-500/30',  bg: 'bg-amber-500/20' },
