...
def _make(  # noqa: PLR0913 — many optional kwargs is the point
    *,
    ...
    tags: list | None = None,
    taxonomy_platforms: list | None = None,
    taxonomy_event_types: list | None = None,
    taxonomy_data_sources: list | None = None,
    ...
    return Detection(
        ...
        tags=tags or [],
        taxonomy_platforms=taxonomy_platforms or [],
        taxonomy_event_types=taxonomy_event_types or [],
        taxonomy_data_sources=taxonomy_data_sources or [],
...
def corpus() -> list[Detection]:
    ...
    return [
        _make(id_="r1", source="sigma",   title="Suspicious PowerShell",
              ...
              taxonomy_platforms=["windows"], taxonomy_event_types=["process"],
        ...
        _make(id_="r2", source="sigma",   title="Linux SSH brute force",
              ...
              taxonomy_platforms=["linux"], taxonomy_event_types=["authentication"],
        ...
        _make(id_="r3", source="splunk",  title="O365 mailbox export",
              ...
              taxonomy_platforms=["o365"], taxonomy_event_types=["audit_event"],
        ...
        _make(id_="r4", source="elastic", title="AWS root login",
              ...
              taxonomy_platforms=["aws"], taxonomy_event_types=["authentication"],
        ...
        _make(id_="r6", source="sentinel", title="Solorigate beacon",
              ...
              taxonomy_platforms=["windows"], taxonomy_event_types=["network"]),
        ...
        _make(id_="r8", source="elastic", title="Cross-platform process anomaly",
              ...
              taxonomy_platforms=["windows", "linux", "macos"],
...
async def test_filter_by_event_categories_uses_taxonomy_event_types(search):
    ...
    `taxonomy_event_types` — explicit URL-backwards-compat behavior."""
