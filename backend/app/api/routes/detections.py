...
async def list_detections(
    ...
    equivalent_in: Optional[str] = Query(None, description="Comma-separated sources: rules that have a same-behaviour rule in any of them (a shared observable plus a shared technique or a second observable; recomputed nightly)"),
    no_equivalent_in: Optional[str] = Query(None, description="Comma-separated sources: rules with no same-behaviour rule in any of them, e.g. source=sigma&no_equivalent_in=elastic for porting gaps"),
    ...
    filters = SearchFilters(
        ...
        equivalent_in=_parse_csv(equivalent_in),
        no_equivalent_in=_parse_csv(no_equivalent_in),
...
async def search_detections(
    ...
    filters = SearchFilters(
        ...
        equivalent_in=params.equivalent_in,
        no_equivalent_in=params.no_equivalent_in,
...
async def get_facets(
    ...
    equivalent_in: Optional[str] = Query(None),
    no_equivalent_in: Optional[str] = Query(None),
    db: AsyncSession = Depends(get_db),
):
