...
SPARSE_CHECKOUT_PATTERNS = {
    ...
    "pypanther": [
        # Rule classes only -- the repo also carries the framework
        # package itself (base.py, cli, cache, ...), tests/, docs/.
        "pypanther/rules/**",
        # Autogenerated LogType str-Enum: the parser reads it to
        # resolve `LogType.AWS_CLOUDTRAIL` -> "AWS.CloudTrail" so
        # taxonomy resolution reuses the panther-analysis mapping.
        "pypanther/log_types.py",
    ],
}
...
class RepositorySyncService:
    ...
    REPO_CONFIGS = {
        ...
        "pypanther": {
            "url": settings.pypanther_repo_url,
            "name": "pypanther",
        },
    }
